...
<a href="https://t.me/imxTaR" style="text-decoration: none; color: inherit;">
  <i class="fas fa-bolt"></i> imxTaR® <i class="fas fa-bolt"></i>
</a>
...
<a href="https://t.me/imxTaR" style="text-decoration: none; color: inherit;">
  <span class="badge bg-primary me-2">
    <i class="fas fa-robot"></i> Join @imxTaR
  </span>
</a>

            <a href="http://t.me/imxTaR" class="text-decoration-none">
    ...
    pdf_links = "".join(
        ...
        f'<button class="btn-action download" onclick="downloadFile(\'{obfuscate_url(url)}\', \'{name} - @imxtar.pdf\')" title="Download PDF">'
...
async def handle_txt2html(client: Client, message: Message):
    ...
    try:
        ...
        # Save HTML file with @imxtar suffix
        base_name = os.path.splitext(file_name)[0]
        html_file_name = f"{base_name}_@imxtar .html"
